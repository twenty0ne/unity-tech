...
[System.Serializable]
public class MyUNETServerController
{
    ...
    public NetworkClient myClient
    {
        get
        {
            return MyNetworkManager.instance.myClient;
        }
        set
        {
            MyNetworkManager.instance.myClient = value;
        }
    }
    ...
    {
        //if (MyNetworkManager.Instance.lobbyConnectionState != MyNetworkManager.SessionConnectionState.CONNECTED)
        //{
        ...
        MyNetworkManager.instance.RegisterNetworkPrefabs();
